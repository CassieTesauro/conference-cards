...
export const StudentForm = () => {
    ...
    // /*~~~~~~~POST STUDENT, PARENT ONE, PARENT TWO STATE TO API; REROUTE TO ROSTER VIEW ~~~~~~~~~~*///wrap in functions
    ...
    return (
        <>
            ...
            {/*~~~~~~~FORM BUTTONS ~~~~~~~~~~*/}
            <button onClick={() => console.log("button clicked")} className="btn btn-primary">
                Save
            </button>
